%% train_dnn2_ls.m
% DNN2 LS: postprocessor MLP training (all noise groups) in a single file.
% Baseline flow is aligned with y_train_dnn2.m, while using LS dataset/checkpoint paths.
...
outFile = fullfile(outDir, "dnn2_postprocess_ls_" + noiseLabel + ".mat");
...
% /<noiseLabel>/xPF  [2, T, N] (LS estimate is stored in xPF for compatibility)
